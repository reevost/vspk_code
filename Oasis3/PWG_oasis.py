...
print('-----------------------------------------------------------------------------------')
if vsk_flag:
    print('========== report of Persistence Weighted Gaussian Kernel with VSPK in dimension %s ===========' % d)
else:
    print('========= report of Persistence Weighted Gaussian Kernel without VSPK in dimension %s =========' % d)
print('-----------------------------------------------------------------------------------')
